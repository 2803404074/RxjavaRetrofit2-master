...
public class MyAnimatorUtil {
    ...
    public void startAnimator(){
        ...
        view.measure(0, 0);
        valueAnimator = ValueAnimator.ofInt(0, DensityUtil.dip2px(mContext,250)).setDuration(300);
    ...
    public void stopAnimator(){
        ...
        view.measure(0, 0);
        valueAnimator = ValueAnimator.ofInt(DensityUtil.dip2px(mContext,250),0).setDuration(300);
    ...
    private void setHeightTing(final View view, boolean isShow){
