...
public abstract class RecyclerAdapter2<T> extends RecyclerView.Adapter<BaseRecyclerHolder> {
    ...
    public RecyclerAdapter2(Context mContext, List<T> mDatas, int mLayoutId) {
    ...
    public void onBindViewHolder(BaseRecyclerHolder holder, final int position) {
        if (getItemViewType(position) == TYPE_NORMAL) {
            ...
            if (mHeadView != null) {
                convert(holder,position, mDatas.get(position - 1));
